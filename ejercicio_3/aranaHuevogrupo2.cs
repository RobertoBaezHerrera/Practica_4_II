...
public class aranaHuevogrupo2 : MonoBehaviour
{
    ...
    void Start()
    {
        arana_notificador.OnAranaColision += ActivarMovimiento;
    ...
    void Update()
    {
        if (movimiento_activo) {
            ...
            rbarana.AddForce(new Vector3(direccion.x, 0, direccion.z).normalized * velocidad, ForceMode.Force);
